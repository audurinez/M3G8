...
var greeting = "Hello World!"; // It is common to start a new code with hello world
var girlName = "Auður"; // Line number 3 and 4 are both strings, meaning they are text
var girlAge = 34; // this is a number
var loveCooking = false; // this is a boolean to help the code to make decisions
...
var productList = ["banana", "toiletpaper", "milk", "chocolate"];
var numbers = [1, 2, 3, 4];
...
var result = add(3000, 1000);
function diff(a, b) {
    return a - b;
}
var minus = diff(3000, 1000);
console.log(minus);
